...
final class LevelSubmitContextImpl implements ClientLevelRenderEvent.SubmitContext {
    private final SubmitCustomGeometryEvent event;
    
    LevelSubmitContextImpl(SubmitCustomGeometryEvent event) {
        this.event = event;
    }
