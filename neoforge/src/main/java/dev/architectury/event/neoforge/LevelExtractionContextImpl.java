...
final class LevelExtractionContextImpl implements ClientLevelRenderEvent.ExtractionContext {
    ...
    // ExtractLevelRenderStateEvent hands out a LevelExtractor rather than the renderer as of 26.2, and extraction
    // always runs on the client's own renderer, so read it back off Minecraft the way the submit context does.
    @Override
