...
public class FluidStackHooksImpl {
    ...
    public static TextureAtlasSprite getStillTexture(@Nullable BlockAndTintGetter level, @Nullable BlockPos pos, FluidState state) {
        ...
        return atlasSprite(IClientFluidTypeExtensions.of(state).getStillTexture());
    }
    ...
    public static TextureAtlasSprite getStillTexture(FluidStack stack) {
        ...
        return atlasSprite(IClientFluidTypeExtensions.of(stack.getFluid()).getStillTexture(FluidStackHooksForge.toForge(stack)));
    }
    ...
    public static TextureAtlasSprite getStillTexture(Fluid fluid) {
        ...
        return atlasSprite(IClientFluidTypeExtensions.of(fluid).getStillTexture());
    }
    ...
    public static TextureAtlasSprite getFlowingTexture(@Nullable BlockAndTintGetter level, @Nullable BlockPos pos, FluidState state) {
        ...
        return atlasSprite(IClientFluidTypeExtensions.of(state).getFlowingTexture());
    }
    ...
    public static TextureAtlasSprite getFlowingTexture(FluidStack stack) {
        ...
        return atlasSprite(IClientFluidTypeExtensions.of(stack.getFluid()).getFlowingTexture(FluidStackHooksForge.toForge(stack)));
    }
    ...
    public static TextureAtlasSprite getFlowingTexture(Fluid fluid) {
        ...
        return atlasSprite(IClientFluidTypeExtensions.of(fluid).getFlowingTexture());
    }
    ...
    @OnlyIn(Dist.CLIENT)
    @Nullable
    private static TextureAtlasSprite atlasSprite(@Nullable net.minecraft.resources.Identifier texture) {
        if (texture == null) {
            return null;
        }
