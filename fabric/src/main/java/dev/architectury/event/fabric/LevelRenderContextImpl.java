...
class LevelRenderContextImpl implements ClientLevelRenderEvent.RenderContext {
    private final AbstractLevelRenderContext context;
    
    LevelRenderContextImpl(AbstractLevelRenderContext context) {
        this.context = context;
    }
    
    @Override
    public LevelRenderer levelRenderer() {
        return context.levelRenderer();
    }
